...
import IconLogin from './src/components/Icon/IconLogin';
import IconSearch from './src/components/Icon/IconSearch';
import IconMessagesDot from './src/components/Icon/IconMessagesDot';
import IconPhone from './src/components/Icon/IconPhone';
import IconUserPlus from './src/components/Icon/IconUserPlus';
import IconBell from './src/components/Icon/IconBell';
import IconMenu from './src/components/Icon/IconMenu';
import IconMessage from './src/components/Icon/IconMessage';
import IconPhoneCall from './src/components/Icon/IconPhoneCall';
import IconVideo from './src/components/Icon/IconVideo';
import IconCopy from './src/components/Icon/IconCopy';
import IconTrashLines from './src/components/Icon/IconTrashLines';
import IconShare from './src/components/Icon/IconShare';
import IconMoodSmile from './src/components/Icon/IconMoodSmile';
import IconSend from './src/components/Icon/IconSend';
import IconMicrophoneOff from './src/components/Icon/IconMicrophoneOff';
import IconDownload from './src/components/Icon/IconDownload';
import IconCamera from './src/components/Icon/IconCamera';
...
const Chat = () => {
    ...
    // Get user role from token using helper
    ...
    if (token && typeof token === 'string') {
        try {
            const jwtDecodeFunc = (jwtDecode as any).default || jwtDecode;
            decodedToken = jwtDecodeFunc(token);
            console.log('Debug: decodedToken in Chat.tsx:', decodedToken);
    ...
    // Debug logs for userRole, token and email
    useEffect(() => {
        console.log('Debug: userRole in Chat.tsx:', userRole);
        console.log('Debug: token in localStorage:', token);
        console.log('Debug: userEmail in Chat.tsx:', userEmail);
        if (userRole !== 'admin') {
            console.warn('Access Denied: userRole is not admin');
        }
        if (!userEmail || userEmail.toLowerCase() !== 'yashchoudhari4301@gmail.com') {
            console.warn('Access Denied: userEmail does not match expected email');
        }
    }, [userRole, userEmail]);
