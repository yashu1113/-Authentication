...
const Header = () => {
    ...
    return (
        <header className={`fixed top-0 left-0 right-0 z-[9999] isolate ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="shadow-sm dark:shadow-none">
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black" style={{ transform: 'none' }}>
